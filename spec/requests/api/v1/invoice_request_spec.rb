...
describe 'Invoices API' do
  describe 'record endpoints' do
    ...
    it "sends a list of invoices" do
      create_list(:invoice, 4, customer_id: @customer.id, merchant_id: @merchant.id)
    ...
    it "can find an invoice by its attributes" do
      invoice_1 = create(:invoice, status: 'pending', customer_id: @customer.id, merchant_id: @merchant.id)
      invoice_2 = create(:invoice, status: 'shipped', customer_id: @customer.id, merchant_id: @merchant.id)
    ...
    it "can find all invoices matching an attribute" do
      invoice_1 = create(:invoice, status: 'pending', customer_id: @customer.id, merchant_id: @merchant.id)
      invoice_2 = create(:invoice, status: 'shipped', customer_id: @customer.id, merchant_id: @merchant.id)
      invoice_3 = create(:invoice, status: 'shipped', customer_id: @customer.id, merchant_id: @merchant.id)
